...
pub const PRESENTER_SUB_RESIZED_2_5X_BOTTOM_SCREEN: PresenterScreen = PresenterScreen::new(
    ...
    (PRESENTER_SCREEN_HEIGHT - PRESENTER_SUB_RESIZED_2_5X_SCREEN_HEIGHT_BOT) * 2 / 3,
    PRESENTER_SUB_RESIZED_2_5X_SCREEN_WIDTH_BOT,
    PRESENTER_SUB_RESIZED_2_5X_SCREEN_HEIGHT_BOT,
);

pub const PRESENTER_SUB_PIP_SCREEN_WIDTH_TOP:  u32 = PRESENTER_SCREEN_HEIGHT as u32 * 4 / 3;
pub const PRESENTER_SUB_PIP_SCREEN_HEIGHT_TOP: u32 = PRESENTER_SCREEN_HEIGHT as u32;
pub const PRESENTER_SUB_PIP_SCREEN_WIDTH_BOT:  u32 = DISPLAY_WIDTH as u32 * 6 / 5;
pub const PRESENTER_SUB_PIP_SCREEN_HEIGHT_BOT: u32 = DISPLAY_HEIGHT as u32 * 6 / 5;
pub const PRESENTER_SUB_PIP_TOP_SCREEN: PresenterScreen = PresenterScreen::new(
    0,
    0,
    PRESENTER_SUB_PIP_SCREEN_WIDTH_TOP,
    PRESENTER_SUB_PIP_SCREEN_HEIGHT_TOP,
);
pub const PRESENTER_SUB_PIP_BOTTOM_SCREEN: PresenterScreen = PresenterScreen::new(
    PRESENTER_SCREEN_WIDTH - PRESENTER_SUB_PIP_SCREEN_WIDTH_BOT - GAP,
    PRESENTER_SCREEN_HEIGHT - PRESENTER_SUB_PIP_SCREEN_HEIGHT_BOT - GAP,
    PRESENTER_SUB_PIP_SCREEN_WIDTH_BOT,
    PRESENTER_SUB_PIP_SCREEN_HEIGHT_BOT,
);
...
pub const PRESENTER_SUB_PIP: ScreenTopology = ScreenTopology {
    top: PRESENTER_SUB_PIP_TOP_SCREEN,
    bottom: PRESENTER_SUB_PIP_BOTTOM_SCREEN,
    mode: ScreenMode::Pip,
};